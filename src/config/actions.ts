...
export const matchActions: readonly MatchActionDefinition[] = [
  ...
  { id: 'attack-pass', label: 'Passada', phase: 'attack', category: 'non-shot', playerSelection: 'all', endsPossession: false },
  { id: 'attack-reception', label: 'Recepci\u00f3', phase: 'attack', category: 'non-shot', playerSelection: 'all', endsPossession: false },
